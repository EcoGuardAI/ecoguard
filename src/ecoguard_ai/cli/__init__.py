...
def analyze(
    ...
    try:
        ...
        if config:
            ...
            console.print(f"[yellow]Config file support coming in future release: {config}[/yellow]")
...
def _display_single_result(result: AnalysisResult, format_type: str, output_file: Optional[str]):
...
def _display_project_result(project_result: ProjectAnalysisResult, format_type: str, output_file: Optional[str]):
...
def _display_table_result(result: AnalysisResult):
    ...
    summary_table.add_row("Security Score", f"{result.calculate_security_score():.1f}/100")
...
def _display_project_table(project_result: ProjectAnalysisResult):
    ...
    summary_table.add_row("Overall Green Score", f"{project_result.calculate_overall_green_score():.1f}/100")
    summary_table.add_row("Overall Security Score", f"{project_result.calculate_overall_security_score():.1f}/100")
