...
class TestIssue:
    ...
    def test_issue_severity_score(self):
        ...
        debug_issue = Issue(
            rule_id="test", category="quality", severity="debug",
            message="Debug", file_path="test.py", line=1
        )
        warning_issue = Issue(
            rule_id="test", category="quality", severity="warning",
            message="Warning", file_path="test.py", line=1
        )
        critical_issue = Issue(
            rule_id="test", category="quality", severity="critical",
            message="Critical", file_path="test.py", line=1
        )
